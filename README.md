...
* We have provided the model checkpoints for the models used in the paper in google drive at [https://drive.google.com/drive/folders/1e-LtSwKld3QjH2SJ2_y_JUHn1F9xc1Qr](https://drive.google.com/drive/folders/1e-LtSwKld3QjH2SJ2_y_JUHn1F9xc1Qr). To use them, download them and move them to the `legibility-estimation/MODEL/bordercut/weights/` directory. This will allow you to move onto **3. Evaluation**, or you can train a model on your own by following the steps below.
