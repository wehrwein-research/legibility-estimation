...
from model import BinaryModel, BinaryFinetunerDataset, get_train_and_val_loader 
...
def main():
    ...
    model = BinaryModel(train_path=cfg['train_path'], val_path=cfg['val_path'], prefix=prefix, lr=cfg['lr'], 
            batch_size=cfg['batch_size'], weight_decay=cfg['weight_decay'],  blur_kernal_size=cfg['blur_kernal_size'], 
            colorshift=cfg['colorshift'], dropout=cfg["dropout"], backbone=cfg["model_type"])
